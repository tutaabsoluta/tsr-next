        ...
        <div className="md:bg-gray-800/90 backdrop-blur-sm rounded-3xl p-4 md:p-12 md:shadow-xl md:border border-gray-700/50">
          ...
          >
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              >
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-orange-400/20 text-orange-300 text-sm font-medium mb-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12 md:px-12">
              ...
              <motion.div
                ...
                className="bg-gray-700 backdrop-blur-sm rounded-2xl p-4 md:p-8 border border-gray-600 relative overflow-hidden"
              >
                ...
                <div className="mb-8">
                  <div className="text-lg font-semibold text-orange-300 mt-4 mb-8">
              ...
              <div className="flex flex-col gap-6">
                ...
                <motion.div
                  ...
                  className="bg-gray-700 backdrop-blur-sm rounded-2xl p-6 border border-gray-600"
                >
                  <div className="mb-4">
                    <div className="text-sm font-semibold text-orange-300 mb-3">100% Recomendados</div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <motion.div
                    ...
                    className="bg-gray-700 backdrop-blur-sm rounded-2xl p-4 border border-gray-600"
                  >
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <h6 className="font-medium text-xs text-white">
                          {sideTestimonials[1]?.name}
                        </h6>
                        <p className="text-xs text-slate-400">{sideTestimonials[1]?.title}</p>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className="bg-orange-400/20 backdrop-blur-sm rounded-2xl p-4 border border-orange-400/30"
                  >
                    <p className="text-sm italic text-slate-300 mb-3">
                    ...
                    <div className="flex items-center">
                      <div>
                        ...
                        <p className="text-xs text-slate-400">{sideTestimonials[2]?.title}</p>
                      </div>
                    </div>
                  </motion.div>
                </div>
